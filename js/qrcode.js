// js/qrcode.js — Canonical QR Code Generator (Kazuhiko Arase / MIT/BSD License)
// Zero external dependencies, pure vanilla JS, 100% compliant with standard phone camera scanners.
 ...
 */
export function generateQRCodeSVG(text, { size = 180, margin = 3, color = '#111827', bgColor = '#FFFFFF' } = {}) {
  // Use auto-detect typeNumber = 0 and Error Correction Level L/M for high scan reliability
  const qr = new QRCodeModel(0, QRErrorCorrectLevel.L);
  qr.addData(text);
  qr.make();
